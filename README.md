...
\*git clone https://github.com/Errytagedesign/hello-react-front-end
...
Feel free to check the [issues page](https://github.com/Errytagedesign/hello-react-front-end/issues).
